        ...
        while (redflag || blueflag)
        {
            if(redflag)
            {
                if(red>=life[redSeq[rednow]])
                {
                    ...
                    if (redSeq[rednow]==0) {cout<<"It has a "<<weapon[redNum%3]<<",and it's morale is "<<fixed<<setprecision(2)<<red*1.0/life[0]<<endl;}
                    else if(redSeq[rednow]==1) {cout<<"It has a "<<weapon[redNum%3]<<" and a "<<weapon[(redNum+1)%3]<<endl;}
                    else if(redSeq[rednow]==2) {cout<<"It has a "<<weapon[redNum%3]<<endl;}
                    else if(redSeq[rednow]==3) {cout<<"It's loyalty is "<<red<<endl;}
                    rednow=(rednow+1)%5;
                }
                else
                {
            ...
            if(blueflag)
            {
                if(blue>=life[blueSeq[bluenow]])
                {
                    ...
                    if (blueSeq[bluenow]==0) {cout<<"It has a "<<weapon[blueNum%3]<<",and it's morale is "<<fixed<<setprecision(2)<<blue*1.0/life[0]<<endl;}
                    else if(blueSeq[bluenow]==1) {cout<<"It has a "<<weapon[blueNum%3]<<" and a "<<weapon[(blueNum+1)%3]<<endl;}
                    else if(blueSeq[bluenow]==2) {cout<<"It has a "<<weapon[blueNum%3]<<endl;}
                    else if(blueSeq[bluenow]==3) {cout<<"It's loyalty is "<<blue<<endl;}
                    bluenow=(bluenow+1)%5;
                }
                else
                {
